...
print("==== Starting data fetch for BBC ====")
...
for index, row in table_sources.iterrows():
  ...
  print("Fetching data for BBC: " + feed_name)
...
table_content = pd.read_csv("Output/BBC.csv")
# Backup data file
...
# Write to CSV
table_content.to_csv("Output/BBC.csv", index=False)
    
print("==== Ending data fetch for BBC ====")
